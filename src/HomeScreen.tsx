...
export const Home = (): JSX.Element => {
  ...
  const navigateToWeightTracker = () => {
    navigate("/weight-tracker", { state: { from: location.pathname } });
  };

  return (
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white w-[375px] h-screen relative">
        <ScrollArea className="h-full">
          ...
          <div className="flex flex-col gap-4 px-8 mt-6">
            <div className="flex justify-between items-center">
              <h2 className="text-black-color font-semibold">
                {t('Health Tracking')}
              </h2>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <Card className="p-4 cursor-pointer hover:bg-gray-50" onClick={navigateToPeriodTracker}>
                <div className="flex flex-col gap-2">
                  <Calendar className="w-6 h-6 text-primary" />
                  <h3 className="font-medium">{t('Period Tracking')}</h3>
                  <p className="text-sm text-gray-500">{t('Track your cycle')}</p>
                </div>
              </Card>

              <Card className="p-4 cursor-pointer hover:bg-gray-50" onClick={navigateToWeightTracker}>
                <div className="flex flex-col gap-2">
                  <Scale className="w-6 h-6 text-primary" />
                  <h3 className="font-medium">{t('Weight Tracking')}</h3>
                  <p className="text-sm text-gray-500">{t('Monitor your progress')}</p>
                </div>
              </Card>
            </div>
          </div>
          ...
          <div className="px-8 mt-8">
            <div className="grid grid-cols-2 gap-4">
              <div 
                className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#92A3FD] to-[#9DCEFF] p-4 hover:opacity-90 transition-opacity cursor-pointer"
                onClick={() => navigate('/period-tracker', { state: { from: location.pathname } })}
              >
                <div className="relative z-10">
                  <h3 className="font-semibold text-white mb-1">Zyklus</h3>
                  <p className="text-white/80 text-sm">Tracke deinen Zyklus</p>
                </div>
              ...
              <div 
                className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#92A3FD] to-[#9DCEFF] p-4 hover:opacity-90 transition-opacity cursor-pointer"
                onClick={() => navigate('/water-intake', { state: { from: location.pathname } })}
              >
                <div className="relative z-10">
                  <h3 className="font-semibold text-white mb-1">Wasser</h3>
                  <p className="text-white/80 text-sm">Tracke deine Wasseraufnahme</p>
                </div>
                <div className="absolute right-2 bottom-2 text-white/20">
              ...
              <div 
                className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#92A3FD] to-[#9DCEFF] p-4 hover:opacity-90 transition-opacity cursor-pointer col-span-2"
                onClick={() => navigate('/weight-tracker', { state: { from: location.pathname } })}
              >
                <div className="relative z-10">
                  <h3 className="font-semibold text-white mb-1">Gewicht</h3>
                  <p className="text-white/80 text-sm">Tracke dein Gewicht</p>
                </div>
                <div className="absolute right-2 bottom-2 text-white/20">
